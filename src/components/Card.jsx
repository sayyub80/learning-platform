        ...
        <div className=" mt-1 md:mt-0 md:w-[800px] pl-4 md:pl-7 md:pt-4 flex flex-col content-around ">
          ...
          <div className="mt-5 ">
            ...
            <div className="flex items-center relative pb-20 md:pb-0">
              ...
              <p className="mx-7 text-gray-500 line-through">
                Rs{props.orgPrice}
              </p>
              ...
              <Link to={props.path}>
                {" "}
                <button className="absolute md:bottom-5 left-0 md:left-auto bottom-5  md:right-2 shadow-[0_4px_5px_rgba(0,0,0,0.3)] bg-[#0d6efd]  text-white px-8 py-2 rounded  duration-500 hover:scale-105">
                  Explore
                </button>
              </Link>
            </div>
